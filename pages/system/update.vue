...
<template>
  <div class="container">
    ...
    <div class="update-section">
      ...
      <div v-if="showLogs && logs.length > 0" class="log-container" :class="{ 'completed': completed }">
        <div class="log-header" :class="{ 'success': completed && success, 'error': completed && error }">
